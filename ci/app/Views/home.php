                            ...
                            <div role="tabpanel" aria-hidden="false" class="fade tab-pane active show">
                                <div id="pools">
                                    <section class="py-12">
                                        <div class="container">
                                            <section class="mb-12">
                                                <h2 class="SectionTitle_title__1O2hJ ">Active Pools (<?=$activePoolsCount?>)</h2>
                                            ...
                                            <section class="mb-12">
                                                <h2 class="SectionTitle_title__1O2hJ ">Upcoming Pools (<?=$upcomingPoolsCount?>)</h2>
                                            ...
                                            <section class="mb-12">
                                                <h2 class="SectionTitle_title__1O2hJ ">Ended Pools (<?=$endedPoolsCount?>)</h2>
