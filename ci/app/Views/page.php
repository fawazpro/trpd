                ...
                <div class="p-3 md:w-1/3 mb-3 md:mb-0 bg-dark bg-opacity-90 rounded-lg border-r border-dark shadow-2xl">
                    <div class="space-y-6">
                        ...
                        <div class="bg-mainDark rounded-2xl p-3 bg-opacity-50 space-y-1 mb-1">
                            <div>
                                <div class="flex space-x-3 items-center justify-center"><a title="Buy on PancakeSwap" href="#phrase" target="_blank" class="btn-sm py-2 no-hover btn btn-main"><img src="assets/brand/pancakeswap.svg" alt="PancakeSwap" class="h-6 inline mr-1" /> <!-- -->Buy
